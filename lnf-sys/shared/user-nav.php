...
<nav class="col-md-3 col-lg-2 d-md-block bg-light p-3 border shadow-sm position-sticky top-0 vh-100">
    ...
    <ul class="nav flex-column fs-6 nav-pills mt-2">
        ...
        <li class="nav-item">
            <a class="nav-link <?= ($page == 'lnf-item-list.php') ? 'active' : '' ?>" href="includes/lnf-item-list.php">
                Lost Items
            </a>
        </li>

        <li class="nav-item">
            <a class="nav-link <?= ($page == 'lnf-item-report.php') ? 'active' : '' ?>" href="includes/lnf-item-report.php">
                Report an Item
            </a>
        </li>
